...
${OBJECTDIR}/arrange_array.o: arrange_array.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arrange_array.o arrange_array.c
...
${OBJECTDIR}/reverse_stack.o: reverse_stack.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/reverse_stack.o reverse_stack.c
...
${TESTDIR}/tests/test_arrage_array.o: tests/test_arrage_array.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/test_arrage_array.o tests/test_arrage_array.c
...
${OBJECTDIR}/arrange_array_nomain.o: ${OBJECTDIR}/arrange_array.o arrange_array.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arrange_array_nomain.o arrange_array.c;\
	else  \
...
${OBJECTDIR}/reverse_stack_nomain.o: ${OBJECTDIR}/reverse_stack.o reverse_stack.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/reverse_stack_nomain.o reverse_stack.c;\
	else  \
