...
${OBJECTDIR}/find_diverse.o: find_diverse.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/find_diverse.o find_diverse.c
...
${OBJECTDIR}/max_combination.o: max_combination.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/max_combination.o max_combination.c
...
${OBJECTDIR}/n_digits.o: n_digits.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/n_digits.o n_digits.c
...
${OBJECTDIR}/strs.o: strs.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/strs.o strs.c
...
${OBJECTDIR}/find_diverse_nomain.o: ${OBJECTDIR}/find_diverse.o find_diverse.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/find_diverse_nomain.o find_diverse.c;\
	else  \
...
${OBJECTDIR}/max_combination_nomain.o: ${OBJECTDIR}/max_combination.o max_combination.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/max_combination_nomain.o max_combination.c;\
	else  \
...
${OBJECTDIR}/n_digits_nomain.o: ${OBJECTDIR}/n_digits.o n_digits.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/n_digits_nomain.o n_digits.c;\
	else  \
...
${OBJECTDIR}/power_nomain.o: ${OBJECTDIR}/power.o power.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/power_nomain.o power.c;\
	else  \
...
${OBJECTDIR}/strs_nomain.o: ${OBJECTDIR}/strs.o strs.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/strs_nomain.o strs.c;\
	else  \
